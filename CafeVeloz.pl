/*
Enunciado: https://github.com/lgo1980/cafe-veloz/blob/master/LOG_CafeVeloz_20111C.pdf
VER OTRA RESOLUCION EN CLASE:
Otra resolucion: https://github.com/lgo1980/cafe-veloz/blob/master/solucion.pl
*/
...
% relaciona la m�xima cantidad de un producto que 1 jugador puede ingerir
maximo(cocacola, 3). 
maximo(gatoreit, 1).
maximo(naranju, 5).
...
% sustancias prohibidas por la asociaci�n
