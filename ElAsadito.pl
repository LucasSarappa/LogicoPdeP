Otra resolucion: https://github.com/NicolasOcchi/Prolog_Modelos_de_Parciales/tree/master/El_Asadito
Otra resolucion: https://github.com/btorrico/Practica-Paradigma-Logico/tree/main/El%20Asadito
/*
