https://github.com/caroblanco/PDP_parciales_2020/blob/master/PROLOG-LOGICO/2020-l-trabajadoresEstresados/trabajadoresEstresados.pl

Otra resolucion: https://github.com/Prolog-Uqbar/Integrador-Trabajadores-estresados
